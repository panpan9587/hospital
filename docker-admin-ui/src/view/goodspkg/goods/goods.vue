<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="goodsType字段" prop="goodsType" width="120" />
        <el-table-column align="left" label="cover字段" prop="cover" width="120" />
    ...
    <el-drawer size="800" v-model="detailShow" :before-close="closeDetailShow" title="查看详情" destroy-on-close>
        ...
        <el-descriptions :column="1" border>
                ...
                <el-descriptions-item label="goodsType字段">
                        {{ formData.goodsType }}
                </el-descriptions-item>
                <el-descriptions-item label="cover字段">
                        {{ formData.cover }}
                </el-descriptions-item>
