...
func Routers() *gin.Engine {
	...
	{
		doctorrecipeRouter := router.RouterGroupApp.Doctorrecipe
		doctorrecipeRouter.InitRecipeRouter(PrivateGroup, PublicGroup)
	}
	{
		doctormentRouter := router.RouterGroupApp.Doctorment
		doctormentRouter.InitShiftRouter(PrivateGroup, PublicGroup)
	}
	{
	...
	{
		healthsRouter := router.RouterGroupApp.Healths
		healthsRouter.InitHealthRouter(PrivateGroup, PublicGroup)
	}
