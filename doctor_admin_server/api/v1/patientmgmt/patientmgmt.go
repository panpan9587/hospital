...
var userService = service.ServiceGroupApp.PatientmgmtServiceGroup.UserService
...
// @Param data body patientmgmt.User true "创建患者表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"创建成功"}"
// @Router /user/createUser [post]
func (userApi *UserApi) CreateUser(c *gin.Context) {
	var user patientmgmt.User
...
// @accept application/json
// @Produce application/json
// @Param data body patientmgmt.User true "删除患者表"
...
// @accept application/json
// @Produce application/json
// @Param data body patientmgmt.User true "更新患者表"
...
// @accept application/json
// @Produce application/json
// @Param data query patientmgmt.User true "用id查询患者表"
...
// GetUserList 分页获取患者表列表
// @Tags User
// @Summary 分页获取患者表列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query patientmgmtReq.UserSearch true "分页获取患者表列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /user/getUserList [get]
func (userApi *UserApi) GetUserList(c *gin.Context) {
	var pageInfo patientmgmtReq.UserSearch
