...
// @Param data body patient.User true "创建用户表"
...
// @accept application/json
// @Produce application/json
// @Param data body patient.User true "删除用户表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /user/deleteUser [delete]
func (userApi *UserApi) DeleteUser(c *gin.Context) {
	ID := c.Query("ID")
	userID := utils.GetUserID(c)
	if err := userService.DeleteUser(ID, userID); err != nil {
...
func (userApi *UserApi) DeleteUserByIds(c *gin.Context) {
	...
	userID := utils.GetUserID(c)
	if err := userService.DeleteUserByIds(IDs, userID); err != nil {
...
// @accept application/json
// @Produce application/json
// @Param data body patient.User true "更新用户表"
...
// @accept application/json
// @Produce application/json
// @Param data query patient.User true "用id查询用户表"
...
// GetUserList 分页获取用户表列表
// @Tags User
// @Summary 分页获取用户表列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query patientReq.UserSearch true "分页获取用户表列表"
